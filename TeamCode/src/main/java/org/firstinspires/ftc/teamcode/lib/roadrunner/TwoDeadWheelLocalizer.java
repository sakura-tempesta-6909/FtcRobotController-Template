...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -23.25175258877528; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -12473.651838190483; // x position of the perpendicular encoder (in tick units)
    }
